...
import type WaterfallChartModel from '../charts/WaterfallChartModel';
...
export default class WaterfallChart extends ViewPU {
    ...
    setInitiallyProvidedValue(params: WaterfallChart_Params) {
    ...
    updateStateVars(params: WaterfallChart_Params) {
    }
    ...
    initialRender() {
            ...
            Column.onAccessibilityHover((isHover: boolean, event: AccessibilityHoverEvent) => {
                ...
                try {
                    if (this.model) {
                        ...
                        AppStorage.setOrCreate(Constants.WATER_CHART_ACCESS, true);
                        ...
                        if (highlight) {
                            ...
                            if (this.isAccessBool) {
                                ...
                                if (entry && entry instanceof WaterfallEntry) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TapGesture.onAction((event?: GestureEvent) => {
                if (event && this.model) {
                    AppStorage.setOrCreate(Constants.WATER_CHART_ACCESS, false);
