...
export default abstract class ChartTouchListener<T extends Chart<ChartData<IDataSet<EntryOhos>>>> {
    ...
    abstract onAccessUp(event: AccessibilityHoverEvent): void;
    abstract accessDown(event: AccessibilityHoverEvent): void;
    abstract accessUp(event: AccessibilityHoverEvent): void;
