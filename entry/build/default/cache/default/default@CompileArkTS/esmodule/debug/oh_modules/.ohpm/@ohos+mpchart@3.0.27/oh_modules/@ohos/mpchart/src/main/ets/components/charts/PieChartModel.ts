...
import PieChartRenderer from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/renderer/PieChartRenderer";
import PieHighlighter from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/highlight/PieHighlighter";
...
import type { FontFamily } from '../data/Paint';
/**
...
export default class PieChartModel extends PieRadarChartBase<PieData> {
    ...
    public setCenterTextSize(sizeDp: number): void {
        ( /*(PieChartRenderer)*/this.mRenderer as PieChartRenderer).getPaintCenterText().setTextSize(Utils.handleDataValues(sizeDp));
    }
    /**
