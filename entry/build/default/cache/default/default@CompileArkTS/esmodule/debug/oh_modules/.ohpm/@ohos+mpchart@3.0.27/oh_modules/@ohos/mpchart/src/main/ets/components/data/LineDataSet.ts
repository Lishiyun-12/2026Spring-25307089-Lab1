...
import LineRadarDataSet from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/data/LineRadarDataSet";
import type EntryOhos from './EntryOhos';
import type ILineDataSet from '../interfaces/datasets/ILineDataSet';
import type IFillFormatter from '../formatter/IFillFormatter';
import DefaultFillFormatter from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/formatter/DefaultFillFormatter";
...
import ColorTemplate, { ChartColor } from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/utils/ColorTemplate";
...
export class LineDataSet extends LineRadarDataSet<EntryOhos> implements ILineDataSet {
    ...
    getCircleColor(index: number): number {
        return this.mCircleColors.get(index)?.valueOf() ?? 0;
    }
