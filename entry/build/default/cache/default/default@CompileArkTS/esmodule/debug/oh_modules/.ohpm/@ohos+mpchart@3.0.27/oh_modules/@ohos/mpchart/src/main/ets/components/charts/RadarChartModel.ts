...
import RadarHighlighter from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/highlight/RadarHighlighter";
import RadarChartRenderer from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/renderer/RadarChartRenderer";
import XAxisRendererRadarChart from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/renderer/XAxisRendererRadarChart";
import YAxisRendererRadarChart from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/renderer/YAxisRendererRadarChart";
...
import PieRadarChartBase from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/charts/PieRadarChartBaseModel";
...
export default class RadarChartModel extends PieRadarChartBase<RadarData> {
     ...
     */
    private mWebColor: number = ChartColor.rgb(122, 122, 122);
    /**
     * color for the inner web
     */
    private mWebColorInner: number = ChartColor.rgb(122, 122, 122);
    /**
    ...
    protected init() {
        ...
        this.mWebLineWidth = Utils.handleDataValues(1.5);
        this.mInnerWebLineWidth = Utils.handleDataValues(0.75);
        if (this.mAnimator) {
    ...
    public setWebLineWidth(width: number): void {
        this.mWebLineWidth = Utils.handleDataValues(width);
    }
    ...
    public setWebLineWidthInner(width: number): void {
        this.mInnerWebLineWidth = Utils.handleDataValues(width);
    }
