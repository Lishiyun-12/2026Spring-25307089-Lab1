...
import type { JList } from '../utils/JList';
...
import Fill from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/utils/Fill";
