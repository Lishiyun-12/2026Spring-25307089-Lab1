...
export default class CandleStickChartRenderer extends LineScatterCandleRadarRenderer {
    ...
    public drawData(c: CanvasRenderingContext2D): void {
        try {
            LogUtil.log('CandleStickChartRenderer drawData - start');
            MPChartTraceUtil.startInfo(TraceLogConstants.Tag.CandleStickChartSetData);
            if (!this.mChart) {
                return;
            }
            ...
            LogUtil.info('CandleStickChartRenderer drawData succeed  ' + `candleData: ${JSON.stringify(candleData)}`);
        }
        catch (e) {
            LogUtil.error('CandleStickChartRenderer drawData error', e);
            MPChartTraceUtil.startError(TraceLogConstants.Tag.CandleStickChartSetData);
        }
        finally {
            LogUtil.log('CandleStickChartRenderer drawData - end');
            MPChartTraceUtil.finish(TraceLogConstants.Tag.CandleStickChartSetData);
        }
    }
    ...
    public drawValues(c: CanvasRenderingContext2D): void {
        try {
            LogUtil.log('CandleStickChartRenderer drawValues - start');
            MPChartTraceUtil.startInfo(TraceLogConstants.Tag.CandleStickChartDrawValues);
            if (!this.mChart) {
                return;
            }
            ...
            LogUtil.error('CandleStickChartRenderer drawValues error', e);
            MPChartTraceUtil.startError(TraceLogConstants.Tag.CandleStickChartDrawValues);
        }
        finally {
            LogUtil.log('CandleStickChartRenderer drawValues - end');
            MPChartTraceUtil.finish(TraceLogConstants.Tag.CandleStickChartDrawValues);
        }
    }
