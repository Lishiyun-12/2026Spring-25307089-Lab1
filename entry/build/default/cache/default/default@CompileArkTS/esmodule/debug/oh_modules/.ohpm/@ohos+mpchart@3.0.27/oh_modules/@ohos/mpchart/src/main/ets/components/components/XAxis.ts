...
export class XAxis extends AxisBase {
    ...
    private mLabelXInfos: LabelInfo[] = [];
    constructor() {
        super();
        this.mYOffset = Utils.handleDataValues(4);
    }
    public setLabelXInfos(labelInfos: LabelInfo[]) {
        this.mLabelXInfos = labelInfos;
    }
    public getLabelXInfos(): LabelInfo[] {
        return this.mLabelXInfos;
    }
    //
