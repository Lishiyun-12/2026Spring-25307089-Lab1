import { LegendOrientation, LegendHorizontalAlignment, LegendVerticalAlignment } from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/components/Legend";
...
import HorizontalBarHighlighter from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/highlight/HorizontalBarHighlighter";
import type IBarDataSet from '../interfaces/datasets/IBarDataSet';
import HorizontalBarChartRenderer from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/renderer/HorizontalBarChartRenderer";
import XAxisRendererHorizontalBarChart from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/renderer/XAxisRendererHorizontalBarChart";
import YAxisRendererHorizontalBarChart from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/renderer/YAxisRendererHorizontalBarChart";
import HorizontalViewPortHandler from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/utils/HorizontalViewPortHandler";
...
import TransformerHorizontalBarChart from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/utils/TransformerHorizontalBarChart";
...
import ChartModel from "@package:pkg_modules/.ohpm/@ohos+mpchart@3.0.27/pkg_modules/@ohos/mpchart/src/main/ets/components/charts/ChartModel";
export default class HorizontalBarChartModel extends BarChartModel {
    ...
    public calculateOffsets(): void {
        ...
        let minOffset = Utils.handleDataValues(this.mMinOffset);
        ...
        if (this.mLogEnabled) {
            LogUtil.log(ChartModel.LOG_TAG, "offsetLeft: " + offsetLeft + ", offsetTop: " + offsetTop + ", offsetRight: " +
                offsetRight + ", offsetBottom: "
                + offsetBottom);
            LogUtil.log(ChartModel.LOG_TAG, "Content: " + this.mViewPortHandler.getContentRect().toString());
        }
    ...
    public getHighlightByTouchPoint(x: number, y: number): Highlight | null {
        if (this.mData == null) {
            if (this.mLogEnabled) {
                LogUtil.log(ChartModel.LOG_TAG, "Can't select by touch. No data set.");
            }
            return null;
        }
        else {
