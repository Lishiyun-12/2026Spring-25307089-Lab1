## 3.0.27
- Fix optimize barrel file exports, use direct re-export instead of import-then-export

## 3.0.26
- Add trace logging for chart rendering
- Add DFX logging for chart rendering
- Add Funnel Chart
- Add WordCloud Chart
- Add Rose Chart
- Add Gauge Chart
